 ...
 */
JERRY_ATTR_ALWAYS_INLINE ecma_object_t *
 ...
 * @return pointer to allocated memory
 */
JERRY_ATTR_ALWAYS_INLINE ecma_extended_object_t *
 ...
 * @return pointer to allocated memory
 */
JERRY_ATTR_ALWAYS_INLINE ecma_getter_setter_pointers_t *
 ...
 * @return pointer to allocated memory
 */
JERRY_ATTR_ALWAYS_INLINE ecma_property_pair_t *
